...
type NavBarContentProps = NavBarProps & { showTopBar: boolean };

function NavBarContent({ name, search, api, downloads, docs, contact, homepage, items, placement, showTopBar }: NavBarContentProps): ReactElement {
